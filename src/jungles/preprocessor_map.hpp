/**
 * @file        preprocessor_map.hpp
 * @brief       Some preprocessor magic to explode variadic macros to bitfields.
 * @author      Kacper Kowalski - kacper.s.kowalski@gmail.com
 */
#ifndef PREPROCESSOR_MAP_HPP
#define PREPROCESSOR_MAP_HPP
